...
Write a function that returns true if this
Binary Tree is height balanced and false if
it isn't.
A Binary Tree is height balanced if for each
node in the tree, the difference between the
height of its left subtree and the height of its
...
//SOLUTION 1
//TIME COMPLEXITY O(n) | SPACE COMPLEXITY O(h) - where n is the number of nodes
// in the binary tree
